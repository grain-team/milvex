defmodule Milvex.Milvus.Proto.Milvus.MilvusService.Service do
  ...
  rpc(
    :AlterAlias,
    Milvex.Milvus.Proto.Milvus.AlterAliasRequest,
    Milvex.Milvus.Proto.Common.Status
  )
  ...
  rpc(
    :AlterIndex,
    Milvex.Milvus.Proto.Milvus.AlterIndexRequest,
    Milvex.Milvus.Proto.Common.Status
  )
  ...
  rpc(
    :Insert,
    Milvex.Milvus.Proto.Milvus.InsertRequest,
    Milvex.Milvus.Proto.Milvus.MutationResult
  )

  rpc(
    :Delete,
    Milvex.Milvus.Proto.Milvus.DeleteRequest,
    Milvex.Milvus.Proto.Milvus.MutationResult
  )

  rpc(
    :Upsert,
    Milvex.Milvus.Proto.Milvus.UpsertRequest,
    Milvex.Milvus.Proto.Milvus.MutationResult
  )
  ...
  rpc(
    :Import,
    Milvex.Milvus.Proto.Milvus.ImportRequest,
    Milvex.Milvus.Proto.Milvus.ImportResponse
  )
  ...
  rpc(
    ...
    Milvex.Milvus.Proto.Milvus.GetReplicateConfigurationRequest,
    Milvex.Milvus.Proto.Milvus.GetReplicateConfigurationResponse
  )
  ...
  rpc(
    :DumpMessages,
    Milvex.Milvus.Proto.Milvus.DumpMessagesRequest,
    stream(Milvex.Milvus.Proto.Milvus.DumpMessagesResponse)
  )
end
